...
public sealed class ContaE2ETests : E2ETestsBase
{
    ...
    [TestMethod]
    public async Task DeveConsultar_DetalhesDaConta_ComPedidos()
    {
        await RegistrarEEntrarAsync("conta.detalhes@teste.local", "Senha123!");

        // TODO: implementar módulo Pedido
        // ProdutoFormPage produtoForm = new(Page, UrlBase);
        // await produtoForm.IrParaCadastroAsync();
        // await produtoForm.PreencherAsync("Produto01", 10.00m);
        ...
        // TODO: quando módulo Pedido estiver pronto, descomentar:
        // await Expect(listarPage.Pedido("Cliente Teste", "Produto01")).ToBeVisibleAsync();
        // await Expect(listarPage.Total("Cliente Teste")).ToContainTextAsync("R$ 20,00");
    }

    [TestMethod]
    public async Task DeveAtualizar_Total_AposAlterarQuantidade()
    {
        await RegistrarEEntrarAsync("conta.alterar.quantidade@teste.local", "Senha123!");
        ...
        // TODO: quando módulo Pedido estiver pronto, descomentar:
        // await pedidoForm.AlterarQuantidadeAsync("Cliente Teste", "Produto01", 5);
        // await Expect(listarPage.Total("Cliente Teste")).ToContainTextAsync("R$ 50,00");
    }

    [TestMethod]
    public async Task DeveAtualizar_Total_AposRemoverPedido()
    {
        await RegistrarEEntrarAsync("conta.remover.pedido@teste.local", "Senha123!");
        ...
        // TODO: quando módulo Pedido estiver pronto, descomentar:
        // await pedidoForm.RemoverAsync("Cliente Teste", "Produto01");
        // await Expect(listarPage.Total("Cliente Teste")).ToContainTextAsync("R$ 0,00");
    }
}
