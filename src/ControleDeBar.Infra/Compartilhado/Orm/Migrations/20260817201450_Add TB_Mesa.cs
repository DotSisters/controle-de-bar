...
{
    /// <inheritdoc />
    public partial class AddTB_Mesa : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeLugar = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_TBMesa_UserId_Identificacao",
                table: "TBMesa",
                columns: new[] { "UserId", "Identificacao" },
                unique: true);
        }
