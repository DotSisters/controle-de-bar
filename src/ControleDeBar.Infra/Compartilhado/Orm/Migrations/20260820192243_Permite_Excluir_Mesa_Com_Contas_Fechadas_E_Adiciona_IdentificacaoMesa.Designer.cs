...
namespace ControleDeBar.Infra.Compartilhado.Orm.Migrations
{
    ...
    [Migration("20260820192243_Permite_Excluir_Mesa_Com_Contas_Fechadas_E_Adiciona_IdentificacaoMesa")]
    partial class Permite_Excluir_Mesa_Com_Contas_Fechadas_E_Adiciona_IdentificacaoMesa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ControleDeBar.Dominio.Modulos.ModuloConta.Conta", b =>
                {
                    ...
                    b.Property<string>("IdentificacaoMesa")
                        .IsRequired()
                        .HasMaxLength(100)
